import React from "react"
	...
	<Image source={require('../assets/Login.jpeg')} style={{ width: "100%", height: 500, marginTop: '3%', alignSelf: 'center', resizeMode: 'cover', }}></Image>
	...
	<TouchableOpacity style={{ width: '80%', height: 40, backgroundColor: '#4169E1', justifyContent: 'center', alignItems: 'center',  alignSelf: 'center', marginTop: '3%' }} onPress={() => { this.signIn() }}>
	<Text style={{ fontWeight: 'bold', color: 'white', fontSize: 20 }} >Already an user? Sign in</Text>
	</TouchableOpacity>
