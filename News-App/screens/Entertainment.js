...
export default function Entertainment() {
  ...
  console.log(data);
  const url =
    "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=1f804abc9bf5432db60cbe929928d81f";
    ...
    <>
      {Object.keys(data).length > 0 && (
        ...
        <View style={{flexDirection: 'row',width:'90%', marginTop:'3%',marginLeft:'3%' ,marginRight:'3%', justifyContent:'space-between'}}>
            <View style={{backgroundColor:'#0096FF',borderRadius:10,width:210}}><Text style={{ fontSize: 28, fontWeight: 'bold', alignSelf: 'center', color: 'white' }}>Entertainment</Text></View>
